...
{
    /// <summary>Gets or sets the start of the appointment.</summary>
    DateTime Begin { get; set; }

    /// <summary>Gets or sets the end of the appointment.</summary>
    DateTime End { get; set; }

    /// <summary>Gets or sets the descriptive text for this appointment.</summary>
    string Text { get; set; }

    /// <summary>Gets or sets the highlight color the appointment.</summary>
    Color Color { get; set; }

    /// <summary>Gets or sets the index for this appointment.</summary>
    int Index { get; set; }

    /// <summary>Gets or sets the level of indent.</summary>
    int Indent { get; set; }
    ...
    /// <returns>True if the appointment falls within the time given.</returns>
...
public class AppointmentControl : Border, IAppointmentControl
{
    ...
    /// <inheritdoc />
    public bool IsInRange(DateTime start, DateTime end) => Begin >= start && End <= end;
