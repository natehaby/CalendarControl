...
internal static class DateTimeHelper
{
    ...
    public static DateTimeFormatInfo GetCurrentDateFormat()
    {
        ...
        {
            if (calendar is not GregorianCalendar)
            {
                continue;
            }
    ...
    private static DayState DefaultDayState(DayOfWeek dayOfWeek) => dayOfWeek is DayOfWeek.Saturday or DayOfWeek.Sunday ? DayState.Weekend : DayState.WorkDay;
}